...
resource "azurerm_virtual_hub_connection" "vhub_conn" {
  ...
  virtual_hub_id            = var.virtual_hub_id #data.terraform_remote_state.prd_eastus2_connectivity.outputs.virtual_hub_resource_id #todo spn access to remote state?
